...
mod tests {
    use super::{
        ...
        fresh_offer_payment_context, paid_notify_payment_context, quote_within_audit_window,
        AuditResponderRejectReason, MAX_AUDIT_RESPONSES_PER_PEER, MAX_CONCURRENT_AUDIT_RESPONSES,
