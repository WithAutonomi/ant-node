...
async fn handle_replication_message(
    ...
    match msg.body {
        ...
        ReplicationMessageBody::GetCommitmentByPin(ref request) => {
            ...
            let Some(_guard) = admit_audit_responder(
                &ctx.audit_responder_semaphore,
                &ctx.audit_responder_inflight,
                source,
                AuditResponderClass::Byte,
...
mod tests {
    use super::{
        ...
        update_bootstrap_after_peer_removed, AuditResponderClass, FirstAuditQueueOutcome,
        FirstAuditTerminalOutcome, KeyVerificationOutcome, MonetizedPinEvent,
